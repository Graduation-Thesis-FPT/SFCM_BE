...
('generic-list','item-type',N'Danh mục loại hàng hóa',NULL,1,208,'ItemType','sql','sql'),
('generic-list','unit-list',N'Danh mục đơn vị tính',NULL,1,209,'UnitList','sql','sql'),
('generic-list','customer-type',N'Danh mục loại khách hàng',NULL,1,210,'CustomerType','sql','sql'),
('generic-list','customer-list',N'Danh mục khách hàng',NULL,1,211,'CustomerList','sql','sql'),
('generic-list','tractor-list',N'Danh mục đầu kéo',NULL,0,212,'TractorList','sql','sql'),
('generic-list','trailer-list',N'Danh mục rơ-mooc',NULL,0,213,'TrailerList','sql','sql'),
...
('admin','good-manifest',1,1,1,1,'sql','sql'),
